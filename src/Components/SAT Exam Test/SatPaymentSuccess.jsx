...
import { SatPracticePaymentSuccess } from "../../store/Actions/satpracticeAction";

function SatPaymentSuccess () {
    ...
    useEffect(() => {
        if (user && id) {
          dispatch(SatPracticePaymentSuccess(id, user));
        }
      }, [user, id, dispatch]);
...
export default SatPaymentSuccess
