export const  SAT_Section1_Module2 = [
    {
      ...
      {
        questioninfo: `Researchers have struggled to pinpoint specific causes for hiccups, which happen when a person’s diaphragm contracts _______ . However, neuroscientist Kimberley Whitehead has found that these uncontrollable contractions may play an important role in helping infants regulate their breathing.`,
        question: "Which choice completes the text with the most logical and precise word or phrase?",
        options: [
          "involuntarily",
          "beneficially",
      ...
      {
        questioninfo: `Scholarly discussions of gender in Shakespeare’s comedies often celebrate the rebellion of the playwright’s characters against the rigid expectations _______ by Elizabethan society. Most of the comedies end in marriage, with characters returning to their socially dictated gender roles after previously defying them, but there are some notable exceptions.`,
        question: "Which choice completes the text with the most logical and precise word or phrase?",
        options: [
          "interjected",
          "committed",
      ...
      {
        questioninfo: `The following text is from Charlotte Brontë’s 1847 novel Jane Eyre. Jane works as a governess at Thornfield Hall. <br> <br> I went on with my day’s business tranquilly; but ever and anon vague suggestions kept wandering across my brain of reasons why I should quit Thornfield; and I kept involuntarily framing advertisements and pondering conjectures about new situations: these thoughts I did not think to check; they might germinate and bear fruit if they could.`,
      ...
      },
      {
        ...
        answer: "It is overly optimistic given additional observations from Srivastava and her team."
      },
      {
        questioninfo: `The following text is adapted from William Shakespeare’s 1609 poem “Sonnet 27.” The poem is addressed to a close friend as if he were physically present. <br><br> Weary with toil, I [hurry] to my bed, The dear repose for limbs with travel tired; But then begins a journey in my head To work my mind, when body’s work’s expired: For then my thoughts—from far where I abide— [Begin] a zealous pilgrimage to thee, And keep my drooping eyelids open wide.`,
        ...
        answer: "The speaker is thinking about the friend instead of immediately falling asleep."
      },
      {
        ...
        answer: "He describes the crowd as being united, even though the crowd clearly appears otherwise."
      },
      {
        questioninfo: `<i>O Pioneers!</i> is a 1913 novel by Willa Cather. In the novel, Cather portrays Alexandra Bergson as having a deep emotional connection to her natural surroundings: _______`,
      ...
      
      {
        ...
        answer: "Participants who had been looking at the trees helped the experimenter pick up significantly more pens than did participants who had been looking at the building."
      }
      ,
      {
        questioninfo:  `   <img src="/Images/SAT Test/Module2/Q15.png" alt="Q15 Image"/> <br>      Over the past two hundred years, the percentage of the population employed in the agricultural sector has declined in both France and the United States, while employment in the service sector (which includes jobs in retail, consulting, real estate, etc.) has risen. However, this transition happened at very different rates in the two countries. This can be seen most clearly by comparing the employment by sector in both countries in _______`,
      ...
      },
      {
        ...
        options: [
          ...
          "In the researchers’ study, neither the model nor the archaeologists were able to accurately categorize all the pottery fragments that were presented.",
      ...
      },
      {
        ...
        answer: "a male tanager’s appearance may function as a dishonest signal of the individual’s overall fitness."
      },
      {
        questioninfo: `When writing The Other Black Girl (2021), novelist Zakiya Dalila Harris drew on her own experiences working at a publishing office. The award-winning book is Harris’s first novel, but her writing _______ honored before. At the age of twelve, she entered a contest to have a story published in American Girl magazine—and won.`,
      ...
      },
      {
        ...
        answer: "could the blueberries thrive?"
      },
      {
        questioninfo: `In his 1963 exhibition Exposition of Music—Electronic Television, Korean American artist Nam June Paik showed how television images could be manipulated to express an artist’s perspective. Today, Paik _______ considered the first video artist.`,
        question: "Which choice completes the text so that it conforms to the conventions of Standard English?",
        options: [
          "will be",
          "had been",
      ...
      {
        questioninfo: `Despite being cheap, versatile, and easy to produce, _______ they are made from nonrenewable petroleum, and most do not biodegrade in landfills.`,
        question: "Which choice completes the text so that it conforms to the conventions of Standard English?",
        options: [
      ...
      },
      {
        ...
        answer: "biologist Yuree Lee"
      },
      {
        questioninfo: `Small, flat structures called spatulae are found at the tips of the hairs on a spider’s leg. These spatulae temporarily bond with the atoms of whatever they touch. _______ spiders are able to cling to and climb almost any surface.`,
      ...
      {
        questioninfo: `Before California’s 1911 election to approve a proposition granting women the right to vote, activists across the state sold tea to promote the cause of suffrage. In San Francisco, the Woman’s Suffrage Party sold Equality Tea at local fairs. _______ in Los Angeles, activist Nancy Tuttle Craig, who ran one of California’s largest grocery store firms, distributed Votes for Women Tea.`,
        question: "Which choice completes the text with the most logical transition?",
        options: [
          "For example,",
          "To conclude,",
      ...
      {
        questioninfo: `While researching a topic, a student has taken the following notes: <br> <br>   • The Seikan Tunnel is a rail tunnel in Japan. <br> <br>   • It connects the island of Honshu to the island of Hokkaido.  <br> <br>  • It is roughly 33 miles long. <br> <br>   • The Channel Tunnel is a rail tunnel in Europe.  <br> <br>  • It connects Folkestone, England, to Coquelles, France.  <br> <br>  • It is about 31 miles long. The student wants to compare the lengths of the two rail tunnels.  <br> <br>  Which choice most effectively uses relevant information from the notes to accomplish this goal?`,
        ...
        answer: "The Seikan Tunnel is roughly 33 miles long, while the slightly shorter Channel Tunnel is about 31 miles long."
      },
      {
        questioninfo: `While researching a topic, a student has taken the following notes: <br><br>    • Jon Ching is a Los Angeles-based painter. <br><br>    • He uses the term “flauna” to describe the plant-animal hybrids that he depicts in his surreal paintings. <br><br>    • “Flauna” is a combination of the words “flora” and “fauna.” <br><br>    • His painting Nectar depicts a parrot with leaves for feathers. <br><br>    • His painting Primaveral depicts a snow leopard whose fur sprouts flowers.  <br><br>   The student wants to provide an explanation and example of “flauna.” Which choice most effectively uses relevant information from the notes to accomplish this goal?`,
        question: "Which choice most effectively uses relevant information from the notes to accomplish this goal?",
        options: [
        ...
        answer: "Jon Ching uses the term “flauna,” a combination of the words “flora” and “fauna,” to describe the subjects of his surreal paintings: plant-animal hybrids such as a parrot with leaves for feathers."
      },
      {
        questioninfo: `While researching a topic, a student has taken the following notes: <br><br>   • In the midst of the US Civil War, Susie Taylor escaped slavery and fled to Union-army-occupied St. Simons Island off the Georgia coast. <br><br>   • She began working for an all-Black army regiment as a nurse and teacher.  <br><br>  • In 1902, she published a book about the time she spent with the regiment.  <br><br>  • Her book was the only Civil War memoir to be published by a Black woman. <br><br>   • It is still available to readers in print and online.  <br><br>  The student wants to emphasize the uniqueness of Taylor’s accomplishment. Which choice most effectively uses relevant information from the notes to accomplish this goal?`,
        question: "Which choice most effectively uses relevant information from the notes to accomplish this goal?",
        options: [
        ...
        answer: "Taylor was the only Black woman to publish a Civil War memoir."
      }
