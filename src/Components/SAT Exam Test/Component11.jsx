      ...
      <div className="w-full h-screen center bg-[#F7F7F7]">
        <div className="text-center center flex-col w-full h-[60%] text-xl text-black">
          ...
          <img src="/Images/SAT Test/complete.jpg" alt="" />
            <p className="text-lg">
              Congratulation on completing SAT practice <br /> test see your results
              below
            </p>
            <button className="px-4 py-2 rounded-full bg-yellow-300 font-semibold mt-5 text-base border-2 border-black">View Your Score</button>
          </div>
        </div>
      </div>
    </div>
