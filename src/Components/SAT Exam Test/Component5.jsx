      ...
      <div className="w-full h-screen bg-[#1c1c1c]">
        <div className="w-full h-[90%] flex">
          ...
          <div className="w-[50%] h-full text-white py-10 ">
            ...
            <br />
            <p className="font-semibold text-3xl capitalize">Take a break : do not close your device</p>
            <br /> 
            <p>After te break , a <b>Resume Test Now</b> Button will appear and you'll start the next session.  </p>
            ...
            <br />
            <p>3.Do not access phones, smartwatches, textbooks, notes, or the internet.</p>
            <br />
            <p>4.Do not eat or drink near any testing device.</p>
            <br />
            <p>5.Do not speak in the test room; outside the test room, do not discuss the exam with anyone.</p>
