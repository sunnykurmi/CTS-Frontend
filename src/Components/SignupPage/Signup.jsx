import { RiKeyLine, RiMailLine, RiPhoneLine, RiUserLine } from '@remixicon/react'
      ...
      <div className="w-full h-[100vh] p-10 flex max-[600px]:flex-col">
        ...
        <div className="w-[30%] h-full">
          <div className="w-full flex items-center justify-center h-[20vh]">
            ...
            <h1 className='text-4xl font-semibold  ' >Signup To Cross The <br /> Skylimits</h1>
          </div>
          <div className="w-full pt-5 flex flex-col gap-5 items-center justify-center ">
            ...
            <div className="w-[90%] h-14 flex items-center justify-center overflow-hidden p-2  rounded-full border-2 ">
              <input className='h-full text-xl w-[85%] pr-6 outline-none flex items-center justify-center ' type="text" placeholder='Enter Name' name="" id="" />
              <RiUserLine className='text-[#0000006f]'/>
            </div>
            <div className="w-[90%] h-14 flex items-center justify-center overflow-hidden p-2  rounded-full border-2 ">
              <input className='h-full text-xl w-[85%] pr-6 outline-none flex items-center justify-center ' type="number"  placeholder='Enter contact' name="" id="" />
              <RiPhoneLine className='text-[#0000006f]'/>
            </div>
            <div className="w-[90%] h-14 flex items-center justify-center overflow-hidden p-2  rounded-full border-2 ">
              <input className='h-full text-xl w-[85%] pr-6 outline-none flex items-center justify-center ' type="password" placeholder='Enter Password' name="" id="" />
