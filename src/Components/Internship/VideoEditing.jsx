...
const VideoEditing = () => {
  ...
  const checkLoginHandler = () => {
    if (!isAuth) {
      ...
      navigate("/login", { state: { from: `/apply-internship/video-editing` } });
      return;
    }
  };
    ...
    <>
      ...
      <div className='w-full'>
        <div className="w-full h-fit p-5 flex flex-col items-center">
          ...
          <h1 className="text-4xl max-[600px]:text-2xl font-bold text-center mt-2">Video Editing</h1>
          <p className='mt-3 w-full text-zinc-400 px-48 text-center text-base max-[600px]:px-5'>Bring stories to life! Edit videos, interviews, and shorts to captivate our audience.</p>
          <div className="sat-img w-full h-[40vh] max-[600px]:h-[25vh] mt-10 px-20 max-[600px]:px-0">
            <img className='w-full h-full object-contain max-[600px]:object-cover' src="/Images/internship/veimg.png" alt="" />
          </div>
              ...
              <div className="w-full flex flex-col items-center justify-center">
                ...
                <div className="center mt-5 w-full px-20 max-[600px]:px-5">
                  <div className="w-full grid grid-cols-2 max-[800px]:grid-cols-1 gap-y-5 gap-x-10 max-[600px]:w-64">
                    ...
                    <div className="">
                      <h2 className="font-normal text-sm">Video Editing Experience: Yes/No (Describe if Yes)</h2>
                      <input
                    ...
                    <div className="">
                      <h2 className="font-normal text-sm">Tools Used: (e.g., Premiere Pro, Final Cut Pro)</h2>
                      <input
                        placeholder="Enter your Tools"
                        onChange={handleChange("tools")}
                        value={userInput.tools}
                        type="text"
                        name="tools"
                        className="field rounded-md max-[600px]:h-10"
                      />
                    ...
                    <div className="">
                      <h2 className="font-normal text-sm">Samples of Work: Links or descriptions</h2>
                      <input
