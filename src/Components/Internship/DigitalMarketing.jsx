    ...
    <>
      ...
      <div className='w-full'>
        <div className="w-full h-fit p-5 flex flex-col items-center">
          ...
          <h1 className="text-4xl max-[600px]:text-2xl font-bold text-center mt-2">Digital Marketing</h1>
          <p className='mt-3 w-full text-zinc-400 px-48 text-center text-base max-[600px]:px-5'>Dive into the world of digital marketing! Help us expand our reach through outreach, collaborations, creativity and social media management.</p>
