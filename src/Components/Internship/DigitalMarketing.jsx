...
const DigitalMarketing = () => {
  ...
  const checkLoginHandler = () => {
    if (!isAuth) {
      ...
      navigate("/login", {
        state: { from: `/apply-internship/digital-marketing` },
      });
      return;
    }
  };
      ...
      <div className="w-full">
        <div className="w-full h-fit p-5 flex flex-col items-center">
          ...
          <p className="mt-3 w-full text-zinc-400 px-48 text-center text-base max-[600px]:px-5">
            Dive into the world of digital marketing! Help us expand our reach
            through outreach, collaborations, creativity and social media
            management.
          </p>
          <div className="sat-img w-full h-[40vh] max-[600px]:h-[25vh] mt-10 px-20 max-[600px]:px-0">
            <img
              ...
              src="/Images/internship/DMimg.png"
              alt=""
            />
          </div>
