...
const ContentCreation = () => {
  ...
  const checkLoginHandler = () => {
    if (!isAuth) {
      ...
      navigate("/login", {
        state: { from: `/apply-internship/content-creation` },
      });
      return;
    }
  };
  ...
  const BenefitsCards = [
    ...
    },
    {
      ...
      description1: "Expect exciting surprises along the way!e",
    },
    // {
      ...
      <div className="w-full">
        <div className="w-full h-fit p-5 flex flex-col items-center">
          ...
          <p className="mt-3 w-full text-zinc-400 px-48 text-center text-base max-[600px]:px-5">
            Unleash your creativity! Create engaging content, from blogs to
            videos, and shape the narrative of Cross the Sky Limits.
          </p>
          <div className="sat-img w-full h-[40vh] max-[600px]:h-[25vh] mt-10 px-20 max-[600px]:px-0">
            <img
              ...
              src="/Images/internship/ccimg.png"
              alt=""
            />
          </div>
              ...
              <div className="w-full flex flex-col items-center justify-center">
                ...
                <div className="center mt-5 w-full px-20 max-[600px]:px-5">
                  <div className="w-full grid grid-cols-2 max-[800px]:grid-cols-1 gap-y-5 gap-x-10 max-[600px]:w-64">
                    ...
                    <div className="">
                      <h2 className="font-normal text-sm">
                        What kind of content creation are you interested in?
                      </h2>
                      <input
                        placeholder="Enter your Interest"
                    ...
                    <div className="">
                      <h2 className="font-normal text-sm">
                        Share a sample of your work (if any)
                      </h2>
                      <input
