...
function IVYHome() {
  return (
    <div id="home">
      ...
      <div className="w-full h-40 flex items-center justify-center max-[600px]:h-20">
        <div className="w-[80%] bg-[#f8851127] h-24  rounded-full flex items-center justify-evenly max-[600px]:w-[95%] max-[600px]:h-14">
          <img className="w-[12%]" src="/Images/CTS   Logo.png" alt="" />
          <div className="w-[50%] h-full flex items-center max-[600px]:text-xs justify-evenly font-bold text-[#393E46]  ">
          ...
          <div className="w-[25%] h-full flex items-center justify-evenly  ">
            <Link to="/login">
              <button className="w-32 h-14 max-[600px]:h-6 rounded-full border-2 border-[#0000000c]  font-bold  max-[600px]:hidden">
                LOGIN
              </button>
            </Link>
            <Link to="/signup">
              <button className="w-32 h-14  rounded-full bg-[#F58612] text-white font-bold max-[600px]:scale-50 ">
                REGISTER
              </button>
            </Link>
          </div>
