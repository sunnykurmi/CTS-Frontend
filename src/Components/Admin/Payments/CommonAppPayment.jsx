...
export default function CommonAppPayment() {
  ...
  useEffect(() => {
    ...
    dispatch(getallcommonapppayments()).then((data) => {
      setAllPayments(data);
      setLoading(false);
            ...
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
              <div className="bg-white w-[50vw] p-8 rounded-lg shadow-lg">
                ...
                <table className="table-auto w-full">
                  <tbody>
                    <tr>
                      <td className="border px-4 py-2">Common App Id
                      </td>
                      <td className="border px-4 py-2">
                        {selectedPayment.commonappid
                        }
                      </td>
                    </tr>
                    <tr>
