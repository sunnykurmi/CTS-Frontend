            ...
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
              <div className="bg-white w-[50vw] p-8 rounded-lg shadow-lg">
                ...
                <table className="table-auto w-full">
                  <tbody>
                    <tr>
                      <td className="border px-4 py-2"> Esssay Type</td>
                      <td className="border px-4 py-2">
                        {selectedPayment.essaytype}
                      </td>
                    </tr>
                    <tr>
                      <td className="border px-4 py-2"> Essay File</td>
                      <td className="border px-4 py-2  text-blue-600  ">
                        <Link to={selectedPayment.essayfile}>Link</Link>
                      </td>
                    </tr>
                    <tr>
