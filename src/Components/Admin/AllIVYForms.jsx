...
function AllIVYForms() {
  ...
  const removeApprove = async (user) => {
    setLoadingUsers((prev) => ({ ...prev, [user._id]: true }));
    try {
                ...
                <table className="table-auto w-full">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border px-4 py-2">
                        {selectedUser.physicaldisabilities}
                      </td>
                    </tr>
                    <tr>
                      <td className="border px-4 py-2">Disability Type</td>
                      <td className="border px-4 py-2">
                        {selectedUser.physicaldisabilitiestype}
                      </td>
                    </tr>
                    <tr>
                      <td className="border px-4 py-2">How You Know Us</td>
                      <td className="border px-4 py-2">
                        {selectedUser.howuknow.join(", ")}
                      </td>
                    </tr>
                  </tbody>
                </table>
